...
import com.example.alessandro.sunshine.data.WeatherProvider;
...
public class TestUriMatcher extends AndroidTestCase {
    ...
    public void testUriMatcher() {
        ...
        assertEquals("Error: The WEATHER URI was matched incorrectly.",
                testMatcher.match(TEST_WEATHER_DIR), weatherProvider.getWeather());
        assertEquals("Error: The WEATHER WITH LOCATION URI was matched incorrectly.",
                testMatcher.match(TEST_WEATHER_WITH_LOCATION_DIR), weatherProvider.getWeatherWithLocation());
        assertEquals("Error: The WEATHER WITH LOCATION AND DATE URI was matched incorrectly.",
                testMatcher.match(TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR), weatherProvider.getWeatherWithLocationAndDate());
        assertEquals("Error: The LOCATION URI was matched incorrectly.",
                testMatcher.match(TEST_LOCATION_DIR), weatherProvider.getLocation());
    }
}
