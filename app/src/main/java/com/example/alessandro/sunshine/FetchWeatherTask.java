...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
	...
	private String formatHighLows(double high, double low) {
		...
		String unitType = sharedPrefs.getString(mContext.getString(R.string.unit_key),
				mContext.getString(R.string.metric_string));

		if (unitType.equals(mContext.getString(R.string.imperial_string))) {
			high = (high * 1.8) + 32;
			low = (low * 1.8) + 32;
		} else if (!unitType.equals(mContext.getString(R.string.metric_string))) {
