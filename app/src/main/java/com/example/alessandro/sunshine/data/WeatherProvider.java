 ...
 */
package com.example.alessandro.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
	...
	static {
		...
		sWeatherByLocationSettingQueryBuilder
				.setTables(WeatherContract.WeatherEntry.TABLE_NAME + " INNER JOIN " +
	...
	public int getWeatherWithLocation() {
		return WEATHER_WITH_LOCATION;
	}

	public int getWeatherWithLocationAndDate() {
		return WEATHER_WITH_LOCATION_AND_DATE;
	}
